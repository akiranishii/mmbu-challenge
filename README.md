...
The website is in `site/`. It preserves the content of the [original MMBU Challenge website](https://alejandro-lozano-dev.github.io/MMBU.Challenge/) with a responsive design and a full-width animated hero.
